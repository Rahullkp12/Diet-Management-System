 ...
 * @author antar
 */
@WebServlet(name = "DeleteNu", urlPatterns = {"/DeleteNu"})
public class DeleteNu extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                String  sql= "Delete from Nutritionist where email= '"+EMAIL+"' and N_Id= '"+N_Id+"' and password= '"+PASSWORD+"'";
